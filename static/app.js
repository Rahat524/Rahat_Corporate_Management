...
document.addEventListener('click',e=>{const p=e.target.closest('.nav')?.dataset.page;if(p==='journalVoucher')setTimeout(loadJournalVouchers,50);if(p==='trialBalance')setTimeout(loadTrialBalance,50);if(p==='accruals')setTimeout(loadAccruals,50);if(p==='fixedAssets')setTimeout(loadFixedAssets,50)});
